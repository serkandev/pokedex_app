...
//
//     final pokemonDataModel = pokemonDataModelFromJson(jsonString);

import 'dart:convert';

PokemonDetailModel pokemonDataModelFromJson(String str) => PokemonDetailModel.fromJson(json.decode(str));

String pokemonDataModelToJson(PokemonDetailModel data) => json.encode(data.toJson());
...
class Move {
  ...
  factory Move.fromJson(Map<String, dynamic> json) => Move(
        ...
        versionGroupDetails:
            List<VersionGroupDetail>.from(json["version_group_details"].map((x) => VersionGroupDetail.fromJson(x))),
      );
